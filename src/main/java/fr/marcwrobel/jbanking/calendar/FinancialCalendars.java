 ...
 * <a href="https://wikipedia.org/wiki/List_of_financial_districts">financial districts</a> or financial systems in the
 * world.
 *
 * <p>
 * For the time being only financial districts or financial systems that express their holidays using the
 * <a href="https://wikipedia.org/wiki/Gregorian_calendar">gregorian calendar</a> are supported.
 *
 * <p>
...
public enum FinancialCalendars implements Calendar {
  ...
  /**
   * A special calendar with no holidays and no weekends. All days are business days. It may be used to indicate that a holiday
   * calendar does not apply.
   */
   ...
   *
   * <p>
   * Note that 2017 was the 500th anniversary of the act by Martin Luther which stated the Reformation. In Germany, the 31st of
  ...
  FRANKFURT(new ConfigurableCalendar(SATURDAY, SUNDAY, NEW_YEAR_DAY, GOOD_FRIDAY, EASTER_MONDAY,
      INTERNATIONAL_WORKERS_DAY, ASCENSION_DAY, PENTECOST_MONDAY, FEAST_OF_CORPUS_CHRISTI,
      ...
      new YearRangeHoliday(new MonthDayHoliday(OCTOBER, 31), 2017, 2017), CHRISTMAS_EVE, CHRISTMAS_DAY,
      SAINT_STEPHENS_DAY, NEW_YEAR_EVE)),
   ...
   */
  LONDON(new ConfigurableCalendar(SATURDAY, SUNDAY, new ShiftedHoliday(NEW_YEAR_DAY, WEEKEND_TO_MONDAY), GOOD_FRIDAY,
      EASTER_MONDAY, new MovedHoliday(Holidays.MAY_DAY, d(2020, 5, 4), d(2020, 5, 8)),
      ...
      new DayOfWeekInMonthHoliday(-1, MONDAY, AUGUST), new ShiftedHoliday(CHRISTMAS_DAY, PLUS_TWO_DAYS),
   ...
   */
  NEW_YORK_FED(new ConfigurableCalendar(SATURDAY, SUNDAY, new ShiftedHoliday(NEW_YEAR_DAY, SUNDAY_TO_MONDAY),
      ...
      new DayOfWeekInMonthHoliday(4, THURSDAY, NOVEMBER), new ShiftedHoliday(CHRISTMAS_DAY, SUNDAY_TO_MONDAY))),
   ...
   */
  NEW_YORK_SOCK_EXCHANGE(new ConfigurableCalendar(SATURDAY, SUNDAY,
      new ShiftedHoliday(NEW_YEAR_DAY, SUNDAY_TO_MONDAY),
      // https://wikipedia.org/wiki/Martin_Luther_King_Jr._Day
      new DayOfWeekInMonthHoliday(3, MONDAY, JANUARY),
      // https://wikipedia.org/wiki/Washington%27s_Birthday
      new DayOfWeekInMonthHoliday(3, MONDAY, FEBRUARY), GOOD_FRIDAY,
      // https://wikipedia.org/wiki/Memorial_Day
      new DayOfWeekInMonthHoliday(-1, MONDAY, MAY),
      // https://wikipedia.org/wiki/Juneteenth
      // https://www.officeholidays.com/holidays/usa/new-york/juneteenth
      ...
      new DayOfWeekInMonthHoliday(1, MONDAY, SEPTEMBER),
      // https://wikipedia.org/wiki/Thanksgiving
      new DayOfWeekInMonthHoliday(4, THURSDAY, NOVEMBER), new ShiftedHoliday(CHRISTMAS_DAY, CLOSEST_WEEKDAY),
   ...
   */
  PARIS(new ConfigurableCalendar(SATURDAY, SUNDAY, NEW_YEAR_DAY, EASTER_MONDAY, GOOD_FRIDAY,
      INTERNATIONAL_WORKERS_DAY, VICTORY_IN_EUROPE_DAY, ASCENSION_DAY,
      ...
      new MonthDayHoliday(JULY, 14), ASSUMPTION_OF_MARY, ALL_SAINTS_DAY, ARMISTICE_DAY, CHRISTMAS_DAY,
      SAINT_STEPHENS_DAY)),
  ...
  SYDNEY(new ConfigurableCalendar(SATURDAY, SUNDAY, new ShiftedHoliday(NEW_YEAR_DAY, WEEKEND_TO_MONDAY),
      ...
      new ShiftedHoliday(new MonthDayHoliday(JANUARY, 26), WEEKEND_TO_MONDAY), GOOD_FRIDAY, EASTER_MONDAY,
   ...
   * Real-time Gross settlement Express Transfer (TARGET)</a> closing days.
   *
   * @see <a href="https://www.ecb.europa.eu/press/pr/date/2000/html/pr001214_4.en.html">ecb.europa.eu</a>
   */
  TARGET(new ConfigurableCalendar(SATURDAY, SUNDAY, NEW_YEAR_DAY, GOOD_FRIDAY, EASTER_MONDAY,
      INTERNATIONAL_WORKERS_DAY, CHRISTMAS_DAY, SAINT_STEPHENS_DAY,
   ...
   *
   * <p>
   * This calendar is valid from 2007 until further notice. Last verification occurred on 2021-02-19.
   *
   * @see <a href="https://www.boj.or.jp/en/about/outline/holi.htm/">Holiday Schedule of the Bank of Japan</a>
   */
  TOKYO(new ConfigurableCalendar(SATURDAY, SUNDAY, new ShiftedHoliday(NEW_YEAR_DAY, SUNDAY_TO_MONDAY),
      new MonthDayHoliday(JANUARY, 2), new MonthDayHoliday(JANUARY, 3),
      ...
      new ShiftedHoliday(new MovedHoliday(MonthDay.of(MARCH, 21), MonthDay.of(MARCH, 20), 2000, 2001, 2004, 2005,
          2008, 2009, 2012, 2013, 2016, 2017, 2020, 2021, 2024, 2025, 2026, 2028, 2029, 2030),
          SUNDAY_TO_MONDAY),
      ...
      new YearRangeHoliday(new ShiftedHoliday(new MonthDayHoliday(MAY, 3), SUNDAY_TO_MONDAY), 1950, 2006),
      new YearRangeHoliday(new ShiftedHoliday(new MonthDayHoliday(MAY, 3), SUNDAY_TO_WEDNESDAY), 2007, 2999),
      // https://wikipedia.org/wiki/Greenery_Day from 2007, holiday between holidays before
      new YearRangeHoliday(new ShiftedHoliday(new MonthDayHoliday(MAY, 4), SUNDAY_TO_MONDAY), 1950, 2006),
      new YearRangeHoliday(new ShiftedHoliday(new MonthDayHoliday(MAY, 4), SUNDAY_TO_TUESDAY), 2007, 2999),
      ...
      new YearRangeHoliday(new ShiftedHoliday(new MonthDayHoliday(JULY, 20), SUNDAY_TO_MONDAY), 1950, 2003),
      new YearRangeHoliday(new MovedHoliday(new DayOfWeekInMonthHoliday(3, MONDAY, JULY), d(2020, 7, 20), // The
          // Olympics
          d(2020, 7, 23), d(2021, 7, 19), // Postponement of the Olympics
          d(2021, 7, 22)), 2003, 2999),
      // https://wikipedia.org/wiki/Mountain_Day
      new YearRangeHoliday(new MovedHoliday(new ShiftedHoliday(new MonthDayHoliday(AUGUST, 11), SUNDAY_TO_MONDAY),
          d(2020, 8, 11), // The Olympics
          d(2020, 8, 10), d(2021, 8, 11), // Postponement of the Olympics
          d(2021, 8, 9)), 2016, 2999),
      // https://wikipedia.org/wiki/Respect_for_the_Aged_Day - before 2003
      new YearRangeHoliday(new ShiftedHoliday(new MonthDayHoliday(SEPTEMBER, 15), SUNDAY_TO_MONDAY), 1966, 2002),
      new BridgedHoliday(
          // https://wikipedia.org/wiki/Respect_for_the_Aged_Day - 2003 onward
          new YearRangeHoliday(new DayOfWeekInMonthHoliday(3, MONDAY, SEPTEMBER), ValueRange.of(2003, 2999)),
          // https://www.timeanddate.com/holidays/japan/autumn-equinox
          new ShiftedHoliday(new MovedHoliday(MonthDay.of(SEPTEMBER, 23), MonthDay.of(SEPTEMBER, 22), 2012,
              2016, 2020, 2024, 2028), SUNDAY_TO_MONDAY)),
      // https://wikipedia.org/wiki/Health_and_Sports_Day
      new MovedHoliday(new DayOfWeekInMonthHoliday(2, MONDAY, OCTOBER), d(2020, 10, 12), // The Olympics
          d(2020, 7, 24), d(2021, 10, 11), // Postponement of the Olympics
          d(2021, 7, 23)),
      ...
      new YearRangeHoliday(new ShiftedHoliday(new MonthDayHoliday(DECEMBER, 23), SUNDAY_TO_MONDAY), 1990, 2018),
