...
/**
 * Generate {@link IsoCountry} and {@link IsoCurrency} enum values from the lists provided by the
...
public class EnumGenerator {
  ...
  private static final InputSupplier<? extends InputStream> COUNTRY_FILE_SUPPLIER =
  ...
  private static final Splitter COUNTRY_FILE_SPLITTER =
  ...
  public void countryEnumGenerator() throws IOException {
    InputSupplier<InputStreamReader> supplier =
        CharStreams.newReaderSupplier(COUNTRY_FILE_SUPPLIER, Charsets.UTF_8);
  ...
  private final class CurrencyData {
    ...
    private CurrencyData(String alphaCode, String numCode, String currencyName, String minorUnit) {
      ...
      try {
        this.numCode =
            numCode.isEmpty()
                ? null
                : numCode.equalsIgnoreCase("nil") ? null : Integer.parseInt(numCode);
    ...
    public String toString() {
      ...
      return String.format(
          "%s(\"%s\", %s, %s%s),", name, alphaCode, numCode, minorUnit, countriesString);
    }
  }
