...
public class IbanTest {
  ...
  private static final String VALID_IBAN =
      VALID_IBAN_COUNTRY + VALID_IBAN_CHECKDIGIT + VALID_IBAN_BBAN;
  ...
  private static final String IBAN_WITH_INVALID_FORMAT =
      VALID_IBAN_COUNTRY + VALID_IBAN_CHECKDIGIT + BBAN_WITH_INVALID_FORMAT;

  private static final String IBAN_WITH_UNKNOWN_COUNTRY =
      "ZZ" + VALID_IBAN_CHECKDIGIT + VALID_IBAN_BBAN;
  private static final String IBAN_WITH_UNSUPPORTED_COUNTRY =
      "US" + VALID_IBAN_CHECKDIGIT + VALID_IBAN_BBAN;
  private static final String IBAN_WITH_INVALID_CHECK_DIGIT =
      VALID_IBAN_COUNTRY + "01" + VALID_IBAN_BBAN;
